...
RUN curl -L https://github.com/joseluisq/macosx-sdks/releases/download/15.4/MacOSX15.4.sdk.tar.xz -o /opt/osxcross/tarballs/MacOSX15.4.sdk.tar.xz && \
    git pull && \
    # use a specific version of osxcross (it does not have tags), uses brach 2.0-llvm-based
    git checkout 593fe0260fc7fd4e4ed9462a516b4a5cd454c3ac
# RUN UNATTENDED=1 SDK_VERSION=15.4 ./build.sh
# RUN ENABLE_COMPILER_RT_INSTALL=1 SDK_VERSION=15.4 ./build_compiler_rt.sh && \
